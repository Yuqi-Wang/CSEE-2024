...
f_set = np.load('3f_train_ws_wPC_OLTC_'+str(initial_num)+'_extreme'+'.npy')
w_set = np.load('3w_train_ws_wPC_OLTC_'+str(initial_num)+'_extreme'+'.npy') # all the three weights are given in original file
...
# maximum
print('maximum error')
f1_diff = np.max(np.abs((f_trained[:,0] - f_test[:,0]) / f_test[:,0]))
f2_diff = np.max(np.abs((f_trained[:,1] - f_test[:,1]) / f_test[:,1]))
f3_diff = np.max(np.abs((f_trained[:,2] - f_test[:,2]) / f_test[:,2]))
...
# minimum 
print('minimum error')
f1_diff = np.min(np.abs((f_trained[:,0] - f_test[:,0]) / f_test[:,0]))
f2_diff = np.min(np.abs((f_trained[:,1] - f_test[:,1]) / f_test[:,1]))
f3_diff = np.min(np.abs((f_trained[:,2] - f_test[:,2]) / f_test[:,2]))
print('f1_diff: ',f1_diff)
print('f2_diff: ',f2_diff)
print('f3_diff: ',f3_diff)
...
# mean error
print('mean error')
f1_diff = np.mean(np.abs((f_trained[:,0] - f_test[:,0]) / f_test[:,0]))
f2_diff = np.mean(np.abs((f_trained[:,1] - f_test[:,1]) / f_test[:,1]))
f3_diff = np.mean(np.abs((f_trained[:,2] - f_test[:,2]) / f_test[:,2]))
print('f1_diff: ',f1_diff)
print('f2_diff: ',f2_diff)
print('f3_diff: ',f3_diff)
...
# median error
print('median error')
f1_diff = np.median(np.abs((f_trained[:,0] - f_test[:,0]) / f_test[:,0]))
f2_diff = np.median(np.abs((f_trained[:,1] - f_test[:,1]) / f_test[:,1]))
f3_diff = np.median(np.abs((f_trained[:,2] - f_test[:,2]) / f_test[:,2]))
print('f1_diff: ',f1_diff)
print('f2_diff: ',f2_diff)
print('f3_diff: ',f3_diff)