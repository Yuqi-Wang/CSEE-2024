...
io.savemat('weights_woPC_'+str(num_sample)+'2.mat',{'weights':tune_x})
io.savemat('objectives_woPC_'+str(num_sample)+'2.mat',{'objectives':tune_y})
...
tune_x = np.array([exam_x[:,0], exam_x[:,2], exam_x[:,1]])
tune_y = np.array([exam_y[:,0], exam_y[:,2], exam_y[:,1]])
io.savemat('weights_wPC_'+str(num_sample)+'2.mat',{'weights':tune_x})
io.savemat('objectives_wPC_'+str(num_sample)+'2.mat',{'objectives':tune_y})
