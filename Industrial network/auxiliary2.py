...
print('The w1 is: ' + str(w1))
print('The w2 is: ' + str(w2))


path = './DataFile/'
filename = 'result_obj'+str(obj)+'_w1_'+str(w1)+'_w2_'+str(w2)+'_pv'+str(P_pv_max)+'.npz'
...
print('f_2 is: ', F2) # sum_2 == f2


# F3：电压偏移
F3 = (v_1.sum()+v_2.sum())/N
print('f_3 is: ', F3) # sum_3 == f3
