...
if __name__ == '__main__':
    ...
    while (abs(f1_diff-diff_list1[-2]) > diff_max) or (abs(f2_diff-diff_list2[-2]) > diff_max) or (abs(f3_diff-diff_list3[-2]) > diff_max):
    # while ite < num_iterations:
        ...
        if abs(f1_diff-diff_list1[-2]) > diff_max:
        ...
        if abs(f2_diff-diff_list2[-2]) > diff_max:
        ...
        if abs(f3_diff-diff_list3[-2]) > diff_max:
