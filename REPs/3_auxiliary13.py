...
w2 = 1/3
hour = 0
result = np.load('result_obj4_w1_'+str(w1)+'_w2_'+str(w2)+'_pv0.1_hour_'+str(hour)+'.npz')
...
io.savemat('cap and cost_hour_'+str(hour)+'.mat',{'ene_cap':ene_cap,'pei_cap':pei_cap,'cost_ene_pei_tol':[[cost_ene],[cost_pei],[cost_tol]]})