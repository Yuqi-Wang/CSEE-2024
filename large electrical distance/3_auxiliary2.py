...
io.savemat('weights_woPC_'+str(num_sample)+'_far'+'.mat',{'weights':tune_x})
io.savemat('objectives_woPC_'+str(num_sample)+'_far'+'.mat',{'objectives':tune_y})
io.savemat('objectives_woPC_'+str(num_sample)+'_name_far'+'.mat',{'objectives':tune_y_name})
