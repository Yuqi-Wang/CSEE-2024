from platypus import NSGAII, Problem, Real, Binary, CompoundOperator, SBX, HUX, PM, BitFlip
import numpy as np
import config
import scipy.io
...
population = 2000
upper_limit = 0.01
algorithm = NSGAII(IEEE33(),population_size=population,variator=CompoundOperator(SBX(), HUX(), PM(), BitFlip()))
